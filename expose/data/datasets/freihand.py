...
class FreiHand(dutils.Dataset):
    ...
    def __init__(self, data_path='data/freihand',
                 ...
                 metrics=None,
                 transforms=None,
                 return_params=False,#True,
                 return_vertices=False,#True,
        ...
        logger.info('file_format: {}',file_format)
        if file_format == 'json':
        ...
        if 'test' not in split:
            ...
            right_hand_mean = mean_poses_dict['right_hand_pose']['aa'].squeeze() # maybe delete['aa']
    ...
    def __getitem__(self, index):
        ...
        if hasattr(self, 'translation'): #no trans npz data
