...
target_left_hand_mean=np.array([ 0.11167871,  0.04289218, -0.41644183,  0.10881133, -0.06598568,
...
if __name__ == '__main__':
    ...
    frank_ehf_hand_dir="/data/panyuqing/frankmocap/ehf_raw_res/mocap/"
    ...
    for i in tqdm(range(len(img_names))):
        ...
        #body_pose_mat=raw_body_pose_mat[:,:21,:,:].copy().reshape(21, 3, 3)
        #body_pose_mat=torch.from_numpy(body_pose_mat)
        ...
        frank_ehf_hand_path=frank_ehf_hand_dir+img_name+'_prediction_result.pkl'
        cont=np.load(frank_ehf_hand_path,allow_pickle=True)
        if ('pred_output_list' in cont) and len(cont['pred_output_list'])>0:
            ...
            if right_hand_pose is None:
                ...
                right_hand_pose+=target_right_hand_mean
        ...
        save3dparam['vertices_noshape']=vertices
