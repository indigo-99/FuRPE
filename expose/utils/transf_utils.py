...
def crop(img, center, scale, res, rot=0, dtype=np.float32):
    ...
    # upper left:  [709 427] outside img 480*640
    # bottom right:  [918 636]
    
    # size of cropped image
    #  crop_shape = [br[1] - ul[1], br[0] - ul[0]] #209*209
    ...
    new_shape = [br[1] - ul[1], br[0] - ul[0]]#[209,209]
    if len(img.shape) > 2:
        new_shape += [img.shape[2]] #[209,209,3]
    ...
    # new_x:  (0, -69)
    # new_y:  (0, 53)
    # len(img[0]):640 =shape[1]; len(img):480 =shape[0]
