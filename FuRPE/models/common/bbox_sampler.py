...
class ToCrops(nn.Module):
    ...
    def forward(
        ...
        #logger.info('img_bbox_sizes: {}',img_bbox_sizes)#100-1000 level, no problem
        #logger.info('crop_transforms: {}',crop_transforms)#?
        ...
        #bbox_size is the size of img after being enlarged/reduced according to scale_factor
        #logger.info('points: {}',points)#minus e5
        #logger.info('scale_factor: {}',scale_factor)#2 or 3
        #logger.info('head joint bbox_sizes: {}',bbox_size) #many 0 and some large/small number, making ensuing ndarray all sparse
        #logger.info('head joint crop_size: {}',crop_size)#256
        ...
        #logger.info('head joint orig_bbox_size: {}',orig_bbox_size)
        #logger.info('head joint center: {}',center)
